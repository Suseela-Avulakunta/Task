...
//
//     final currentPrice = currentPriceFromJson(jsonString);

import 'dart:convert';

CurrentPrice currentPriceFromJson(String str) => CurrentPrice.fromJson(json.decode(str));

String currentPriceToJson(CurrentPrice data) => json.encode(data.toJson());
